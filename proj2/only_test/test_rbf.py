...
from proj2.data_provider.data_loader_rbf import Dataset_neural_pd
from proj2.test_model.all_func import visual_all, write_info
...
print(setting, info)
# 绘图展示预测的和真实数据之间的差异
visual_all(all_true, all_pred, folder_path + 'neural.png', args.c_out)
